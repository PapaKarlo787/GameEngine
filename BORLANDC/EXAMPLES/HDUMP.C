...
void                   InitHdump(HANDLE hInstance, HANDLE hPrevInstance,
                                 LPSTR lpszCmdLine, int cmdShow);
void                   InitHdumpFirst(HANDLE hInstance);
void                   InitHdumpAdded(HANDLE hPrevInstance);
void                   InitHdumpEvery(HANDLE hInstance, int cmdShow);
void                   CloseHdump(void);
BOOL FAR PASCAL        About(HWND hDlg, WORD message, WORD wParam, LONG lParam);

long FAR PASCAL        HdumpWndProc(HWND hWnd, WORD message,
...
extern BOOL FAR PASCAL FileOpenDlgProc(HWND hDlg, unsigned iMessage,
                                       WORD wParam, LONG lParam);
...
//
//*******************************************************************
DoFileOpenDlg(HANDLE hInst, HWND hWnd,
              char *szFileSpecIn, char *szDefExtIn,
              WORD wFileAttrIn,
              char *szFilePathOut, char *szFileNameOut)
{
...
//
//*******************************************************************
BOOL FAR PASCAL FileOpenDlgProc(HWND hDlg, WORD iMessage,
                                WORD wParam, LONG lParam)
{
