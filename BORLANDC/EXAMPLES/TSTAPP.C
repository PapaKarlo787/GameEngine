...
void                   InitTstApp(HANDLE hInstance, HANDLE hPrevInstance,
                                 LPSTR lpszCmdLine, int cmdShow);
void                   InitTstAppFirst(HANDLE hInstance);
void                   InitTstAppAdded(HANDLE hPrevInstance);
void                   InitTstAppEvery(HANDLE hInstance, int cmdShow);
void                   CloseTstApp(void);
BOOL FAR PASCAL        About(HWND hDlg, WORD message, WORD wParam, LONG lParam);

long FAR PASCAL        TstAppWndProc(HWND hWnd, WORD message,
