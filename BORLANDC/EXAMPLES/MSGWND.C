...
BOOL                   InitMsgwnd(HANDLE hInstance, HANDLE hPrevInstance,
                                 LPSTR lpszCmdLine, int cmdShow);
BOOL                   InitMsgwndFirst(HANDLE hInstance);
BOOL                   InitMsgwndAdded(HANDLE hPrevInstance);
BOOL                   InitMsgwndEvery(HANDLE hInstance, int cmdShow);
void                   CloseMsgwnd(HWND hWnd);
BOOL FAR PASCAL        About(HWND hDlg, WORD message, WORD wParam, LONG lParam);

long FAR PASCAL        MsgwndWndProc(HWND hWnd, WORD message,
